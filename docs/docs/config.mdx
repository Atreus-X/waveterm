...
| autoupdate:source                    | string   | where updates come from: "atreus" (this fork's builds, from https://www.atreusproject.com/updater/waveterm, the default) or "official" (upstream Wave Terminal builds — installing one replaces this fork's features). Requires app restart |
